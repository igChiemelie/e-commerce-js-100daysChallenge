	...
	<header class="header-v4">
			...
			<div class="wrap-menu-desktop how-shadow1">
				<nav class="limiter-menu-desktop container">
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart cartItem" data-notify="2">
		...
		<div class="wrap-header-mobile">
			...
			<div class="wrap-icon-header flex-w flex-r-m m-r-15">
				...
				<div class="icon-header-item cl2 hov-cl1 trans-04 p-r-11 p-l-10 icon-header-noti js-show-cart cartItem" data-notify="2">
					<i class="zmdi zmdi-shopping-cart"></i>
				</div>
		...
		<div class="menu-mobile">
			...
			<ul class="main-menu-m">
				...
				<li>
					<a href="product" class="label1 rs1" data-label1="hot">Shop</a>
				</li>
			...
			<div class="header-cart-content flex-w js-pscroll">
				...
				<div class="w-full">
					<div class="header-cart-total w-full p-tb-40">
						Total:
						<span class="header-cart-totals"></span>
					</div>
...
<!--===============================================================================================-->
	...
	<script>
		...
		$('.js-addwish-b2').each(function(){
			var nameProduct = $(this).parent().parent().find('.js-name-b2').htmk();
